...
{
    public partial class FormBreak2 : Form
    {
        ...
        private void btnRestaurarTimer_Click(object sender, EventArgs e)
        {
            ...
            Registro.Break_2 = Break_1;
            if (BL_Registro.Break2(Registro) == true)
            {

                MessageBox.Show("Tiempo de Break 2 guardado correctamente");
            }
            else
            {
        ...
        private void FormBreak2_Load(object sender, EventArgs e)
        {
