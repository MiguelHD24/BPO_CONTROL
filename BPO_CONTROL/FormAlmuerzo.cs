...
{
    public partial class FormAlmuerzo : Form
    {
        ...
        private void btnRestaurarTimer_Click(object sender, EventArgs e)
        {
            ...
            Registro.Almuerzo = Break_1;
            if (BL_Registro.Almuerzo(Registro) == true)
            {

                MessageBox.Show("Tiempo de Almuerzo guardado correctamente");
            }
            else
            {
        ...
        private void FormAlmuerzo_Load(object sender, EventArgs e)
        {
